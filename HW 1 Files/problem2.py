...
def dataframe():
    ...
    '''  
        ...
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_dataframe_3pt
        --- OR ---- 
        python -m pytest -v test2.py::test_dataframe_3pt
        ---------------------------------------------------
    '''
...
def load_csv(filename):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_load_csv_3pt
        --- OR ---- 
        python -m pytest -v test2.py::test_load_csv_3pt
        ---------------------------------------------------
    '''
...
def save_csv(X, filename):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_save_csv_3pt
        --- OR ---- 
        python -m pytest -v test2.py::test_save_csv_3pt
        ---------------------------------------------------
    '''
...
def filter_height(X, t):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_filter_height_3pt
        --- OR ---- 
        python -m pytest -v test2.py::test_filter_height_3pt
        ---------------------------------------------------
    '''
...
def group_sum(X, k):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_group_sum_3pt
        --- OR ---- 
        python -m pytest -v test2.py::test_group_sum_3pt
        ---------------------------------------------------
    '''
...
def merge(X, Y, k):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    J = X.merge(Y, how='inner', on=k, suffixes=('_x', '_y'))
    #########################################
    return J
    #------ (3 points / 27 total points) -----------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_merge_3pt
        --- OR ---- 
        python -m pytest -v test2.py::test_merge_3pt
        ---------------------------------------------------
    '''
...
def sort_values(X, k):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_sort_values_3pt
        --- OR ---- 
        python -m pytest -v test2.py::test_sort_values_3pt
        ---------------------------------------------------
    '''
...
def divide(X, k, l):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_divide_3pt
        --- OR ---- 
        python -m pytest -v test2.py::test_divide_3pt
        ---------------------------------------------------
    '''
...
def insert_column(X, y, k):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_insert_column_3pt
        --- OR ---- 
        python -m pytest -v test2.py::test_insert_column_3pt
        ---------------------------------------------------
    '''
...
''' 
    TEST problem 2: (27 points)
        ...
        ----------- test session starts --------------------- 
        * (3 points) test2.py::dataframe_3pt  PASSED 
        * (3 points) test2.py::load_csv_3pt  PASSED 
        * (3 points) test2.py::save_csv_3pt  PASSED 
        * (3 points) test2.py::filter_height_3pt  PASSED 
        * (3 points) test2.py::group_sum_3pt  PASSED 
        * (3 points) test2.py::merge_3pt  PASSED 
        * (3 points) test2.py::sort_values_3pt  PASSED 
        * (3 points) test2.py::divide_3pt  PASSED 
        * (3 points) test2.py::insert_column_3pt  PASSED 
