...
def load_batting(filename='moneyball_batting.csv'):
    ...
    #########################################
    return X
    #------ (3 points / 24 total points) -----------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test3.py::test_load_batting_3pt
        --- OR ---- 
        python -m pytest -v test3.py::test_load_batting_3pt
        ---------------------------------------------------
    '''
...
def filter_batting(X, year):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test3.py::test_filter_batting_3pt
        --- OR ---- 
        python -m pytest -v test3.py::test_filter_batting_3pt
        ---------------------------------------------------
    '''
...
def group_batting(X1):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test3.py::test_group_batting_3pt
        --- OR ---- 
        python -m pytest -v test3.py::test_group_batting_3pt
        ---------------------------------------------------
    '''
...
def merge_player(X2, Y):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test3.py::test_merge_player_3pt
        --- OR ---- 
        python -m pytest -v test3.py::test_merge_player_3pt
        ---------------------------------------------------
    '''
...
def filter_salary(Z, year):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test3.py::test_filter_salary_3pt
        --- OR ---- 
        python -m pytest -v test3.py::test_filter_salary_3pt
        ---------------------------------------------------
    '''
...
def merge_salary(X3, Z1):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test3.py::test_merge_salary_3pt
        --- OR ---- 
        python -m pytest -v test3.py::test_merge_salary_3pt
        ---------------------------------------------------
    '''
...
def filter_min_AB(X4, min_AB):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test3.py::test_filter_min_AB_3pt
        --- OR ---- 
        python -m pytest -v test3.py::test_filter_min_AB_3pt
        ---------------------------------------------------
    '''
...
def filter_max_salary(X5, max_salary):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test3.py::test_filter_max_salary_3pt
        --- OR ---- 
        python -m pytest -v test3.py::test_filter_max_salary_3pt
        ---------------------------------------------------
    '''
...
''' 
    TEST problem 3: (24 points)
        ...
        ----------- test session starts --------------------- 
        * (3 points) test3.py::load_batting_3pt  PASSED 
        * (3 points) test3.py::filter_batting_3pt  PASSED 
        * (3 points) test3.py::group_batting_3pt  PASSED 
        * (3 points) test3.py::merge_player_3pt  PASSED 
        * (3 points) test3.py::filter_salary_3pt  PASSED 
        * (3 points) test3.py::merge_salary_3pt  PASSED 
        * (3 points) test3.py::filter_min_AB_3pt  PASSED 
        * (3 points) test3.py::filter_max_salary_3pt  PASSED 
