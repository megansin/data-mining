...
def compute_BA(H, AB):
    ...
    '''  
        ...
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_compute_BA_3pt
        --- OR ---- 
        python -m pytest -v test1.py::test_compute_BA_3pt
        ---------------------------------------------------
    '''
...
def compute_OBP(H, AB, BB, HBP, SF):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_compute_OBP_3pt
        --- OR ---- 
        python -m pytest -v test1.py::test_compute_OBP_3pt
        ---------------------------------------------------
    '''
...
def compute_B1(H, B2, B3, HR):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_compute_B1_3pt
        --- OR ---- 
        python -m pytest -v test1.py::test_compute_B1_3pt
        ---------------------------------------------------
    '''
...
def compute_TB(B1, B2, B3, HR):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_compute_TB_3pt
        --- OR ---- 
        python -m pytest -v test1.py::test_compute_TB_3pt
        ---------------------------------------------------
    '''
...
def compute_SLG(TB, AB):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_compute_SLG_3pt
        --- OR ---- 
        python -m pytest -v test1.py::test_compute_SLG_3pt
        ---------------------------------------------------
    '''
...
def compute_runs(H, BB, TB, AB):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_compute_runs_3pt
        --- OR ---- 
        python -m pytest -v test1.py::test_compute_runs_3pt
        ---------------------------------------------------
    '''
...
def compute_wins(RC, RA):
    ...
    #########################################
    return W
    #------ (4 points / 22 total points) -----------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_compute_wins_4pt
        --- OR ---- 
        python -m pytest -v test1.py::test_compute_wins_4pt
        ---------------------------------------------------
    '''
...
''' 
    TEST problem 1: (22 points)
        ...
        ----------- test session starts --------------------- 
        * (3 points) test1.py::compute_BA_3pt  PASSED 
        * (3 points) test1.py::compute_OBP_3pt  PASSED 
        * (3 points) test1.py::compute_B1_3pt  PASSED 
        * (3 points) test1.py::compute_TB_3pt  PASSED 
        * (3 points) test1.py::compute_SLG_3pt  PASSED 
        * (3 points) test1.py::compute_runs_3pt  PASSED 
        * (4 points) test1.py::compute_wins_4pt  PASSED 
