...
def count_out_links(A):
    ...
    #########################################
    return d
    #------ (5 points / 48 total points) -----------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test4.py::test_count_out_links_5pt
        --- for Windows OS ---- 
        python -m pytest -v test4.py::test_count_out_links_5pt
        ---------------------------------------------------
    '''
...
def remove_sink_nodes(A):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    for i in range(len(count_out_links(A))):
        if count_out_links(A)[i] == 0:
            A[:,i] = 1
    #########################################
    return A
    #------ (5 points / 48 total points) -----------
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test4.py::test_remove_sink_nodes_5pt
        --- for Windows OS ---- 
        python -m pytest -v test4.py::test_remove_sink_nodes_5pt
        ---------------------------------------------------
    '''
...
def compute_S(A_):
    #########################################
    ## INSERT YOUR CODE HERE (5 points)
    S = remove_sink_nodes(A_).astype('float64')
    for i in range(len(count_out_links(S))):
        S[:,i] = S[:,i]/count_out_links(A_)[i]
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test4.py::test_compute_S_5pt
        --- for Windows OS ---- 
        python -m pytest -v test4.py::test_compute_S_5pt
        ---------------------------------------------------
    '''
...
def compute_G(S, a):
    ...
    G = a*S + (1-a)*(compute_S(np.ones_like(S)))
    #########################################
    return G
    #------ (6 points / 48 total points) -----------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test4.py::test_compute_G_6pt
        --- for Windows OS ---- 
        python -m pytest -v test4.py::test_compute_G_6pt
        ---------------------------------------------------
    '''
...
def random_walk_one_step(G, x):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test4.py::test_random_walk_one_step_6pt
        --- for Windows OS ---- 
        python -m pytest -v test4.py::test_random_walk_one_step_6pt
        ---------------------------------------------------
    '''
...
def all_close(x, y, tol=0.01):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test4.py::test_all_close_5pt
        --- for Windows OS ---- 
        python -m pytest -v test4.py::test_all_close_5pt
        ---------------------------------------------------
    '''
...
def random_walk(G, x, tol=0.01, max_steps=100):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test4.py::test_random_walk_6pt
        --- for Windows OS ---- 
        python -m pytest -v test4.py::test_random_walk_6pt
        ---------------------------------------------------
    '''
...
def add_column_pagerank(X2, x):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test4.py::test_add_column_pagerank_5pt
        --- for Windows OS ---- 
        python -m pytest -v test4.py::test_add_column_pagerank_5pt
        ---------------------------------------------------
    '''
...
def rank_pages(X3):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test4.py::test_rank_pages_5pt
        --- for Windows OS ---- 
        python -m pytest -v test4.py::test_rank_pages_5pt
        ---------------------------------------------------
    '''
...
''' 
    TEST problem 4: (48 points)
        ...
        ----------- test session starts --------------------- 
        * (5 points) test4.py::count_out_links_5pt  PASSED 
        * (5 points) test4.py::remove_sink_nodes_5pt  PASSED 
        * (5 points) test4.py::compute_S_5pt  PASSED 
        * (6 points) test4.py::compute_G_6pt  PASSED 
        * (6 points) test4.py::random_walk_one_step_6pt  PASSED 
        * (5 points) test4.py::all_close_5pt  PASSED 
        * (6 points) test4.py::random_walk_6pt  PASSED 
        * (5 points) test4.py::add_column_pagerank_5pt  PASSED 
        * (5 points) test4.py::rank_pages_5pt  PASSED 
