...
def test_float_array_2pt():
    ...
    assert x[1,-1] ==0.6
#---------------------------------------------------
def test_get_shape_2pt():
    ''' (2 points) get_shape'''
    h,w=get_shape(np.zeros((4,5)))
    assert h == 4
    assert w == 5
#---------------------------------------------------
def test_all_one_matrix_2pt():
...
def test_mat_sum_3pt():
    ...
    assert s[1]==3.
#---------------------------------------------------
def test_mat_scalar_multiplication_3pt():
    ...
    assert Y[1,0]==8.
#---------------------------------------------------
def test_matrix_vector_multiplication_3pt():
