...
def load_webpages(filename):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_load_webpages_5pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_load_webpages_5pt
        ---------------------------------------------------
    '''
...
def count_word_frequency(X, keyword):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_count_word_frequency_5pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_count_word_frequency_5pt
        ---------------------------------------------------
    '''
...
def rank_word_frequency(X1):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test1.py::test_rank_word_frequency_5pt
        --- for Windows OS ---- 
        python -m pytest -v test1.py::test_rank_word_frequency_5pt
        ---------------------------------------------------
    '''
...
''' 
    TEST problem 1: (15 points)
        ...
        ----------- test session starts --------------------- 
        * (5 points) test1.py::load_webpages_5pt  PASSED 
        * (5 points) test1.py::count_word_frequency_5pt  PASSED 
        * (5 points) test1.py::rank_word_frequency_5pt  PASSED 
