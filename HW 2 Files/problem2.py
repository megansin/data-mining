...
def sample_pair(n):
    ...
    '''  
        ...
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_sample_pair_5pt
        --- OR ---- 
        python -m pytest -v test2.py::test_sample_pair_5pt
        ---------------------------------------------------
    '''
...
def facemash():
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_facemash_10pt
        --- OR ---- 
        python -m pytest -v test2.py::test_facemash_10pt
        ---------------------------------------------------
    '''
...
def vote(win_id, lose_id):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test2.py::test_vote_5pt
        --- OR ---- 
        python -m pytest -v test2.py::test_vote_5pt
        ---------------------------------------------------
    '''
...
''' 
    TEST problem 2: (20 points)
        ...
        ----------- test session starts --------------------- 
        * (5 points) test2.py::sample_pair_5pt  PASSED 
        * (10 points) test2.py::facemash_10pt  PASSED 
        * (5 points) test2.py::vote_5pt  PASSED 
