...
def hello_page():
    ...
    '''  
        ...
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_hello_page_5pt
        --- OR ---- 
        python -m pytest -v test1.py::test_hello_page_5pt
        ---------------------------------------------------
    '''
...
def rand_page():
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_rand_page_5pt
        --- OR ---- 
        python -m pytest -v test1.py::test_rand_page_5pt
        ---------------------------------------------------
    '''
...
def vote(ID):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_vote_5pt
        --- OR ---- 
        python -m pytest -v test1.py::test_vote_5pt
        ---------------------------------------------------
    '''
...
def create_template():
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_create_template_5pt
        --- OR ---- 
        python -m pytest -v test1.py::test_create_template_5pt
        ---------------------------------------------------
    '''
...
'''
    ...
    ---- Outputs: --------
        * t: a jinja2 template, which can be used to render a dynamic webpage.
    ---- Hints: --------
        * You could use FileSystemLoader in jinja2 to create an Environment in the current folder (".") and use the created environment to load the template from the file. 
...
def load_template(filename):
    ...
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
        ---------------------------------------------------
        python3 -m pytest -v test1.py::test_load_template_5pt
        --- OR ---- 
        python -m pytest -v test1.py::test_load_template_5pt
        ---------------------------------------------------
    '''
...
''' 
    TEST problem 1: (25 points)
        ...
        ----------- test session starts --------------------- 
        * (5 points) test1.py::hello_page_5pt  PASSED 
        * (5 points) test1.py::rand_page_5pt  PASSED 
        * (5 points) test1.py::vote_5pt  PASSED 
        * (5 points) test1.py::create_template_5pt  PASSED 
        * (5 points) test1.py::load_template_5pt  PASSED 
